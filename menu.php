...
<div class="container-lg">
        <div class="row">
            ...
            <!--End of .col-4 .col-lg-3 .col-md-4  -->
            <div class="col-4 col-lg-3 col-md-4" id="menu-nav">
            ...
            <!-- End of #menu-nav .col-4 .col-lg-3 .col-md-4  -->
        </div>
        <!-- End of .row  -->
        ...
        <div class="row">
            ...
            <!--End of .col-4 .col-lg-3 .col-md-4  -->
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th colspan="2"><button type="button" class="btn btn-primary">Order Now</button>
                                        </th>
                                        <th colspan="2"><button type="button" class="btn btn-danger">Clear List</button>
                                        </th>
                                    </tr>
                                </tfoot>
                                <!-- End of tfoot  -->
                ...
                <!-- End of .col-4 .col-lg-6 .col-md-4 -->
        </div>
        <!-- End of .row  -->
