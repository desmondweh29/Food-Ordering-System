        ...
        <div class=card mb-3" id="details">
            <div class="row g-0">
                <div class="col-md-6 col-lg-6">
                    <img src="images/checkout-bg2.jpg" class="img-fluid rounded-start" id="order-bg" alt="...">
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="typeOption" id="takeAway" value="takeAway" checked>
                                <label class="form-check-label" for="takeAway">Take Away</label>
                            </div>
                            <!-- End of .form-check form-check-inline  -->
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="typeOption" id="delivery" value="delivery">
